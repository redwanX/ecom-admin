...
<div className="modal modal-bottom sm:modal-middle">
  ...
  <label htmlFor="my-modal-6" className="btn btn-sm btn-circle absolute right-2 top-2" onClick={()=>setModalOpen(false)}>✕</label>
  <div className='text-2xl font-bold text-secondary text-center '>ADD PRODUCT</div>
      <hr />
        <div className='my-2 flex flex-col justify-center items-center'>
          ...
          <div className="w-full max-w-xs lg:max-w-2xl">
            <label className="label">
              <span className="label-text font-bold text-primary">Title</span>
            </label>
            <input
                    type="text"
            ...
            <div className="w-full max-w-xs lg:max-w-2xl">
            <label className="label">
              <span className="label-text font-bold text-primary">Brand</span>
            </label>
            <input
                    type="text"
            ...
            <div className="w-full max-w-xs lg:max-w-2xl">
            <label className="label">
              <span className="label-text font-bold text-primary">Category</span>
            </label>
            <input
                    type="text"
                    ...
                    />
                    <label className="label">
                        {errors.cat?.type === 'required' && <span className="label-text-alt text-red-500">{errors.cat.message}</span>}
                    </label>
            </div>
          ...
          <button className='btn btn-md bg-secondary mt-4 w-full' type="submit" onClick={()=>setModalOpen(false)} >Add Product</button>
